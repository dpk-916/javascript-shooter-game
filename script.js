window.addEventListener('load', function(){
     ...
     class Shield{
          ...
          draw(context){
               ...
               this.width, this.height, this.game.player.x, this.game.player.y,
     ...
     class Particle{
          constructor(game, x, y){
               ...
               this.markedForDeletion = false;
               this.angle = 0;
               this.va = Math.random() * 0.4 - 0.1;//rotation speed in radians per animation frame
               this.bounced = 0;
               this.bottomBounceBoundary = Math.random() * 80 + 30;
          }
          update(){
               this.angle += this.va;
     ...
     class Player{
          constructor(game){
               this.game = game;
               this.width = 120; //dimensions of player spritesheet
               this.height = 190;
          ...
          draw(context){
               ...
               if (this.game.gameOver){
                    ...
                    if(this.game.score > this.game.winningScore){
                         message1 = 'Magnificent!';
                         message2 = 'Well done Explorer!';
                    } else {
                         message1 = 'Bummer!';
                         message2 = 'Dig in your heels and try again!';
                    }
